...
// Models on the IONEXT endpoint (paid, per-token — see lib/llm.js). No free-tier
// daily cap, but the whole room shares one key: watch for provider 5xx / throttling
// under burst. Swap these one line each if a model gets deprecated on the day.
//
