...
<p>Thanks!<br>Priya</p>`,
    demoSummary: "### Ticket Summary\n\n**Customer:** Priya Sharma\n**Request:** How to export past invoices as PDF.\n**Suggested reply:** Settings → Billing → Invoices → Download. No sensitive data involved; routed to support.",
  },
  {
    id: "TK-4819",
    from: "Liam Chen",
...
<p>Best,<br>Liam</p>`,
    demoSummary: "### Ticket Summary\n\n**Customer:** Liam Chen\n**Issue:** Reports a possible duplicate Pro-plan charge this month.\n**Suggested action:** Verify billing history and refund the duplicate if confirmed. Route to Billing.",
  },
  {
    id: "TK-4818",
    from: "Dana Okafor",
...
<p>Cheers,<br>Dana</p>`,
    demoSummary: "### Ticket Summary\n\n**Customer:** Dana Okafor\n**Request:** Feature request — dark mode for the dashboard.\n**Suggested action:** Log as product feedback. No action or sensitive data involved.",
  },
];
